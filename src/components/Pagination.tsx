    ...
    return(
        <div className="flex flex-row items-center w-fit">
            <div className="flex items-center mr-2.5">
                <span className="text-gray-400 text-sm mr-2 hidden lg:block xl:block">Показывать:</span>
                <select
                    value={limit}
                    onChange={(e) => handleItemsPerPageChange(e.target.value)}
                    className="w-15 h-10 bg-gray-800 text-white text-sm rounded px-2 py-1 focus:outline-none focus:ring-1 focus:ring-orange-500 last:rounded-b-md mr-2"
                >
                ...
                <span className="text-gray-400 text-sm hidden lg:block xl:block">на странице</span>
            </div>
