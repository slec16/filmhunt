    ...
    return (
        <div className="w-full h-full flex flex-col flex-1 ">
            <div className="flex  flex-col-reverse gap-y-2 lg:flex-row justify-between">
                ...
                <button onClick={() => navigate(-1)} className="p-2 rounded-xl bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white  transition-all duration-200 ease-in-out transform hover:scale-105 active:scale-95 flex items-center justify-center w-10 h-10">
                    <ArrowBackIcon />
                </button>
            </div>
